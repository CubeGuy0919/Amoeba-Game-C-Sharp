...
namespace Amoeba_Game
{
    public class Board
    {
        ...
        //        {
        //            Console.WriteLine($"Row:{i}Column:{j}-Sign:{Matrix[i, j]}");
        //        }
        //        }
        //    }
        //}
        ...
        public void Draw()
        {
            string paddingOffset = new string(' ', 8);

            // Horizontal (ROW) Header Labels
            Console.Write(paddingOffset + "      ");
            ...
            Console.WriteLine(paddingOffset + "    " + new string('═', Size * 2 + 2));

            // Grid Matrix and Column Labels
            for (int rowIndex = 0; rowIndex < Size; rowIndex++)
            {
                // Vertical (COLUMN) Header Labels
                Console.Write(paddingOffset + " " + (rowIndex + 1).ToString().PadRight(2) + " ║ ");
